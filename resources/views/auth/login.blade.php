...
<div class="min-h-screen flex items-center justify-center px-4 py-12 bg-gradient-to-br from-primary-50 via-white to-primary-50">
    <div class="max-w-md w-full">
        ...
        <div class="text-center mb-8">
            <div class="inline-block p-4 bg-gradient-primary rounded-2xl shadow-lg mb-4">
                <svg class="w-12 h-12 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                        d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253" />
                </svg>
            </div>
            <h1 class="text-3xl font-bold text-gray-900 mb-2">IT Learning Hub</h1>
        ...
        <div class="bg-white rounded-2xl shadow-xl p-8">
            ...
            <form method="POST" action="{{ route('login') }}" class="space-y-6">
                ...
                <button
                    type="submit"
                    class="w-full bg-gradient-primary hover:opacity-90 text-white font-semibold 
